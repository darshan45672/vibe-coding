  ...
  const filteredAppointments = appointments
    .filter(appointment => {
      const matchesSearch = appointment.doctor.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          appointment.doctor.email.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          (appointment.notes && appointment.notes.toLowerCase().includes(searchTerm.toLowerCase())) ||
                          (appointment.doctor.specialization && appointment.doctor.specialization.toLowerCase().includes(searchTerm.toLowerCase()))
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
              View and manage all your appointments with doctors across all statuses
            </p>
          </div>
        </div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  >
                    <span className="relative z-10 flex items-center">
                      ...
                      <span className="text-base">Doctor</span>
                      {sortBy === 'doctor' && (
                        <span className="ml-3 p-1 bg-white/20 rounded-full">
                          {sortOrder === 'asc' ? <SortAsc className="h-4 w-4" /> : <SortDesc className="h-4 w-4" />}
                        </span>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      {appointment.doctor.specialization && (
                        <CardDescription className="text-xs text-blue-600 dark:text-blue-400 mt-1 font-medium">
                          {appointment.doctor.specialization}
                        </CardDescription>
                      )}
                    </div>
